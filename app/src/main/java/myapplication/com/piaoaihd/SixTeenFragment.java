...
public class SixTeenFragment extends BaseFragment{
    RecyclerView nineRv;
    SixAdapter nineAdapter;
    ...
    protected void initData(View layout, Bundle savedInstanceState) {
        ...
        nineAdapter = new SixAdapter(getActivity());
        data = new ArrayList<>();
        mList = new ArrayList<>();
        nineRv = (RecyclerView) layout.findViewById(R.id.six_rv);
